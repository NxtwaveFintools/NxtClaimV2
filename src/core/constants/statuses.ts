...
export const DB_FINANCE_ANALYTICS_PIPELINE_STATUSES = [
  DB_SUBMITTED_AWAITING_HOD_APPROVAL_STATUS,
  DB_HOD_APPROVED_AWAITING_FINANCE_APPROVAL_STATUS,
  DB_FINANCE_APPROVED_PAYMENT_UNDER_PROCESS_STATUS,
  DB_PAYMENT_DONE_CLOSED_STATUS,
...
export const DB_FINANCE_NON_REJECTED_VISIBLE_STATUSES = [
  DB_HOD_APPROVED_AWAITING_FINANCE_APPROVAL_STATUS,
  DB_FINANCE_APPROVED_PAYMENT_UNDER_PROCESS_STATUS,
  DB_PAYMENT_DONE_CLOSED_STATUS,
] as const;

export const DB_FINANCE_REJECTED_VISIBLE_STATUSES = [
  DB_REJECTED_RESUBMISSION_NOT_ALLOWED_STATUS,
] as const;

export const DB_FINANCE_VISIBLE_STATUSES = [
  ...DB_FINANCE_NON_REJECTED_VISIBLE_STATUSES,
  ...DB_FINANCE_REJECTED_VISIBLE_STATUSES,
] as const;

export const DB_FINANCE_ACTIONABLE_STATUSES = [
  DB_HOD_APPROVED_AWAITING_FINANCE_APPROVAL_STATUS,
  DB_FINANCE_APPROVED_PAYMENT_UNDER_PROCESS_STATUS,
] as const;

export const DB_FINANCE_EXCLUDED_QUEUE_AND_HISTORY_STATUSES = [
  DB_SUBMITTED_AWAITING_HOD_APPROVAL_STATUS,
  DB_REJECTED_RESUBMISSION_ALLOWED_STATUS,
] as const;
