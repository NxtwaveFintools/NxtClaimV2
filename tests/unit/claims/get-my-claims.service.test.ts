...
function createRepository(overrides?: Partial<ClaimRepository>): ClaimRepository {
  ...
  const repository: ClaimRepository = {
    ...
    createClaimDraft: jest.fn(async () => ({ claimId: null, errorMessage: null })),
    createExpenseDetailDraft: jest.fn(async () => ({ detailId: null, errorMessage: null })),
    createAdvanceDetailDraft: jest.fn(async () => ({ detailId: null, errorMessage: null })),
