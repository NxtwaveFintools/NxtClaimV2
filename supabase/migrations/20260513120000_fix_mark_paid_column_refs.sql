-- Fix process_l2_mark_paid_transition to use renamed column
-- advance_details.requested_amount was renamed to requested_total_amount in 20260512100000
-- expense_details now uses approved_amount (with fallback to requested_total_amount) instead of total_amount
