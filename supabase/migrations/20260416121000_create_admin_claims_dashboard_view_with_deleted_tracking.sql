...
-- Includes both active and soft-deleted claims, plus deleter metadata.
...
select
  ...
  c.deleted_by,
  c.deleted_at,
  nullif(trim(deleted_by_user.full_name), '') as deleted_by_name,
...
alter view public.vw_admin_claims_dashboard
