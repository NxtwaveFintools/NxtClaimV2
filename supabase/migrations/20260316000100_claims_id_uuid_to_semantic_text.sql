...
alter table public.expense_details
  alter column receipt_file_hash type text using receipt_file_hash::text;

alter table public.advance_details
  alter column supporting_document_hash type text using supporting_document_hash::text;
