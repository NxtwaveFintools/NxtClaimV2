...
values
	...
	('Presales-Hubli', true),
	('Presales-Hyderabad', true),
	('Presales-Indore', true),
	...
	('NIAT - Sharda', true),
	('NIAT - Crescent', true),
	('NIAT - Alard University', true),
	('NIAT - Best Innovation University', true),
	('NIAT - Chaitanya University', true),
	('NIAT - Chalapathi', true),
	('NIAT - Geeta University', true),
	('NIAT - Joy University', true),
	('NIAT - Sandip University', true),
	('NIAT - Sansikriti University', true),
	('NIAT - Scope Global Skill University', true),
	('NIAT - St Peter''s Bengaluru', true),
	('NIAT - St Peter''s Chennai', true),
	('NIAT - Sushant University', true),
	('NIAT - Yenepoya University - Bengaluru', true),
	('Other', true)
on conflict (name) do update
set
	is_active = excluded.is_active,
