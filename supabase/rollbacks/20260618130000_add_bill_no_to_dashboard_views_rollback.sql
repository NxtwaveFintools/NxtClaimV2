-- Rollback: remove bill_no from vw_enterprise_claims_dashboard and vw_admin_claims_dashboard
-- CREATE OR REPLACE VIEW cannot remove columns; DROP + recreate is required.

DROP VIEW IF EXISTS public.vw_enterprise_claims_dashboard CASCADE;
...
DROP VIEW IF EXISTS public.vw_admin_claims_dashboard CASCADE;
