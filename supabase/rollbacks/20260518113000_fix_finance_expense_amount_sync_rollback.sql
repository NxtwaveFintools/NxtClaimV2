-- Rollback for: 20260518113000_fix_finance_expense_amount_sync.sql
-- Restores the previous finance-edit RPC behavior before expense amount fields were resynchronized.
