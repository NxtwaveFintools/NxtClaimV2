-- Rollback for 20260521103000_fix_claim_edit_authorization
-- Restores submitter-only authorization behavior for update_claim_by_submitter
-- with auth-check-before-lock ordering from 20260519130000.
...
begin
  ...
  -- AUTH GATE: submitter-only pre-check, no row lock yet.
