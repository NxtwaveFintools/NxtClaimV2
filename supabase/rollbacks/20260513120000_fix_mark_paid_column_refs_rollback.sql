-- Rollback for: 20260513120000_fix_mark_paid_column_refs.sql
-- Restores process_l2_mark_paid_transition to the pre-fix version
-- (references old columns: ed.total_amount, ad.requested_amount).
