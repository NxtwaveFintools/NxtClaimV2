-- Rollback for: 20260519100000_rpc_finance_foreign_currency.sql
-- Restores update_claim_by_finance overloads to their prior definitions and
-- removes update_claim_by_submitter, which did not exist before this migration.
...
DROP FUNCTION IF EXISTS public.update_claim_by_submitter(text, uuid, jsonb);
